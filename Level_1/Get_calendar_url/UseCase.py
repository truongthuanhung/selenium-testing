...
class MoodleTest():
    ...
    def testcase2(self, testid):
        ...
        self.driver.find_element(By.ID, "id_generateurl").click()
        time.sleep(3)
        self.print_result(testid, result and self.verify_success())

    def testcase3(self, testid):
        self.enter_export_calendar()
        self.driver.find_element(By.ID, "id_events_exportevents_all").click()
        self.print_result(testid, self.verify_switchtohome())
   
    def run_test(self):
        self.log_in()
        self.testcase1('TC-061-001')
        self.testcase2('TC-061-002')
        self.testcase3('TC-061-003')
        self.log_out()
