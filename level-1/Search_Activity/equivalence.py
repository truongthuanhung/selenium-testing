...
class SearchActivityEquivalence():
    ...
    def run_test_3(self, idx=3):
        ...
        # Verify output
        output_data = self.driver.find_element(By.XPATH, "//div[@data-region='no-events-empty-message']").text
        print(f"Testcase #{idx} output: {output_data}")
        print(f"Testcase #{idx} expected: {expected_data}")
    ...
    def run_test_4(self, idx=4):
        ...
        # Verify output
        elements = self.driver.find_elements(By.LINK_TEXT, "Technology Talk for EFL Class")
    ...
    def run_test_5(self, idx=5):
        ...
        # Verify output
        elements = self.driver.find_elements(By.XPATH, "//div[@id=\'moodle-dialogue-yui_3_18_1_1_1715247478826_1613-wrap\']/div")
        output_data = len(elements)
        print(f"Testcase #{idx} output: {output_data}")
        print(f"Testcase #{idx} expected: {expected_data}")
...
def main(data_filename):
    ...
    test = SearchActivityEquivalence("student10", "moodle", pd.read_excel(data_path))
